  ...
  const geometry_msgs::msg::Pose pose)
{
  ...
  path_points[3].time_from_start = second2duration(men_time_ * 0.85);
  ...
  const geometry_msgs::msg::Pose pose)
{
  ...
  path_points[0].time_from_start = second2duration(0.0);
  path_points[1].time_from_start = second2duration(dou_time_ * 0.1);
  path_points[2].time_from_start = second2duration(dou_time_ * 0.4);
  path_points[3].time_from_start = second2duration(dou_time_ * 0.6);
  path_points[4].time_from_start = second2duration(dou_time_ * 0.65);
  path_points[5].time_from_start = second2duration(dou_time_ * 0.75);
